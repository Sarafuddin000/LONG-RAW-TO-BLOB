...
--SELECT COUNT(1) FROM PMIS_OHNL.PMIS_EMP_OTHERS_TMP WHERE EMP_PIC_BLOB IS not NULL   	 2540
-- SELECT COUNT(1) FROM PMIS_OHNL.PMIS_EMP_OTHERS WHERE EMP_PIC IS not NULL	   2540


ALTER TABLE PMIS_OHNL.PMIS_EMP_OTHERS DROP COLUMN SLNO;
ALTER TABLE PMIS_OHNL.PMIS_EMP_OTHERS RENAME COLUMN EMP_PIC TO EMP_PIC_LONG;
ALTER TABLE PMIS_OHNL.PMIS_EMP_OTHERS RENAME COLUMN EMP_PIC_blob TO EMP_PIC;
DROP TABLE PMIS_OHNL.PMIS_EMP_OTHERS_TMP;
